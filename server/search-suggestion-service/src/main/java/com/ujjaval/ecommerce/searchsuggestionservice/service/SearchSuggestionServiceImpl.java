        ...
        while (true) {
            try {
                ...
                if (response.statusCode() == 200) {
                    ...
                    System.out.println("Erreur: API impossible à connecter status code = "
                            + response.statusCode());
                }
            } catch (IOException | InterruptedException ioException) {
                System.out.println("Erreur: API impossible à connecter");
                System.out.println("errorMsg = " + ioException);
            } catch (JSONException jsonException) {
                System.out.println("Erreur: impossible d'analyser le JSON");
            ...
            try {
                Thread.sleep(5000);
                System.out.println("Re connetion...");
